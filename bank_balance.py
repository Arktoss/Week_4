...
expenditure_cost = float(input(f"How much does the {expenditure_item} cost: "))
...
checking_balance(customer_name, starting_balance, pay_check, expenditure_item, expenditure_cost)